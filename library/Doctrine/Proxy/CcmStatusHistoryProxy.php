...
class CcmStatusHistoryProxy extends \CcmStatusHistory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setFreezeAlarm($freezeAlarm);
    }

    public function getFreezeAlarm()
    {
        $this->__load();
        return parent::getFreezeAlarm();
    }

    public function setHeatAlarm($heatAlarm)
    {
        $this->__load();
        return parent::setHeatAlarm($heatAlarm);
    }

    public function getHeatAlarm()
    {
        $this->__load();
        return parent::getHeatAlarm();
    }
    ...
    {
        return array('__isInitialized__', 'pkId', 'temperatureAlarm', 'freezeAlarm', 'heatAlarm', 'workingQuantity', 'comments', 'statusDate', 'createdDate', 'modifiedDate', 'utilization', 'ccmAssetType', 'ccm', 'createdBy', 'modifiedBy', 'ccmStatusList', 'reason', 'warehouse');
    }
