...
class ColdChainProxy extends \ColdChain implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setHasVoltage($hasVoltage);
    }

    public function getHasVoltage()
    {
        $this->__load();
        return parent::getHasVoltage();
    }
    ...
    {
        $this->__load();
        return parent::setTemperatureMonitor($temperatureMonitor);
    }

    public function getTemperatureMonitor()
    {
        $this->__load();
        return parent::getTemperatureMonitor();
    }
    ...
    {
        return array('__isInitialized__', 'pkId', 'assetId', 'autoAssetId', 'serialNumber', 'estimateLife', 'workingSince', 'quantity', 'manufactureYear', 'status', 'approvedBy', 'approvedOn', 'hasVoltage', 'createdDate', 'modifiedDate', 'temperatureMonitor', 'ccmStatusHistory', 'ccmAssetType', 'ccmModel', 'source', 'warehouse', 'createdBy', 'modifiedBy');
    }
