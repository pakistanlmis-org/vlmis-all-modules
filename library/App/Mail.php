...
class App_Mail {
    ...
    public static function smtpStart() {
        ...
        self::$mail->Host = "mail.lmis.gov.pk";
        ...
        self::$mail->Username = "feedback@lmis.gov.pk"; // SMTP account username
        //self::$mail->Password = "V2#6nP2i#AzY";        // Changed at June 4, 2018
        self::$mail->Password = "N3#eiY5aK#i2";        // SMTP account password
        self::$mail->SetFrom('feedback@lmis.gov.pk', 'LMIS Feedback');
        self::$mail->AddReplyTo('feedback@lmis.gov.pk', 'LMIS Feedback');
    }
