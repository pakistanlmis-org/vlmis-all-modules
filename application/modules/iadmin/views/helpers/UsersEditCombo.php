...
class Zend_View_Helper_UsersEditCombo extends Zend_View_Helper_Abstract {
     ...
     * @param type $page
     */
    public function usersEditCombo($page, $role_id) {
        ...
        <?php if ($role_id == 38 || $role_id == 39) { ?>
            <input type="hidden" id="combo1_edit" name="combo1_edit" value="">
        <?php } else { ?>
        ...
        <div class="col-md-3" id="div_combodiv_edit" <?php if (empty($translate->div_id) || isset($translate->office_id) == 1 || empty($translate->office_id)) { ?> style="display:none;" <?php } else { ?> style="display:block;"<?php } ?>>
            <label class="control-label" id="lblcombodiv_edit"><?php echo $translate->translate("Division"); ?> <span class="red">*</span></label>
            <div class="controls">
                <select name="combodiv_edit" id="combodiv_edit" class="form-control">
                </select>
            </div>
        </div>
             <?php if ($role_id == 39) { ?>
            <input type="hidden" id="combo2_edit" name="combo2_edit" value="">
        <?php } else { ?>
