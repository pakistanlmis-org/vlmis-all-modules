<?php
/**
 * Zend_View_Helper_StoresEditCombo
 *
 * 
 *
...
/**
 *  Zend View Helper Stores Edit Combo
 */
class Zend_View_Helper_StoresEditCombo extends Zend_View_Helper_Abstract {

    /**
     * Stores Edit Combo
     * Used to load stores combo for edit.
     */
    public function storesEditCombo($warehouse_id, $role_id) {
