...
//        if ($this->_identity->getProvinceId() == 2 || $this->_identity->getRoleId() == 37) {
...
// Open report in edit form after save
    ...
    public function purposeTransferManagementAction() {
        ...
        if ($this->_request->isPost()) {
            echo $product_id = $this->_request->getPost('product');
            $batch_id = $this->_request->getPost('batch');
            echo $transfer_date = $this->_request->getPost('transfer_date');
