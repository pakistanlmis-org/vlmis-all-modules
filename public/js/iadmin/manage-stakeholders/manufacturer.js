$(function() {
    ...
    window.location.href = appName + '/iadmin/manage-stakeholders/manufacturer';
});

    
    $('#records').change(function() {
        var counter = $(this).val();
        document.location.href = appName + '/iadmin/manage-stakeholders/manufacturer/?counter=' + counter;
    });
    ...
    $("#add-stakeholder").validate({
        rules: {
            manufacturer: {
                required: true,
                remote: {
                    url: appName + "/iadmin/manage-stakeholders/check-manufacturer",
                    type: "post",
                    data: {
                        sector: function() {
    ...
    $(".update-asset-sub-type").click(function() {
        $.ajax({
            type: "POST",
            url: appName + "/iadmin/manage-stakeholders/ajax-manufacturer-edit",
