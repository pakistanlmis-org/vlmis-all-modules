$(function() {
    ...
    window.location.href = appName + '/iadmin/manage-stakeholders/stakeholder-sectors';
});

    
    $('#records').change(function() {
        var counter = $(this).val();
        document.location.href = appName + '/iadmin/manage-stakeholders/stakeholder-sectors/?counter=' + counter;
    });
    ...
    $("#add-stakeholder").validate({
        rules: {
            stakeholder_sector: {
                required: true,
                remote: {
                    url: appName + "/iadmin/manage-stakeholders/check-stakeholder-sector"
    ...
    $(".update-asset-sub-type").click(function() {
        $.ajax({
            type: "POST",
            url: appName + "/iadmin/manage-stakeholders/ajax-stakeholder-sector-edit",
            data: {stakeholder_sector_id: $(this).attr('id')},
            dataType: 'html',
