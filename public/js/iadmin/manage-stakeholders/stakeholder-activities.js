$(function() {
    ...
    window.location.href = appName + '/iadmin/manage-stakeholders/stakeholder-activities';
});

    
    $('#records').change(function() {
        var counter = $(this).val();
        document.location.href = appName + '/iadmin/manage-stakeholders/stakeholder-activities/?counter=' + counter;
    });
    ...
    $("#add-stakeholder").validate({
        rules: {
            stakeholder_activity: {
                required: true,
                remote: {
                    url: appName + "/iadmin/manage-stakeholders/check-stakeholder-activity"
    ...
    $(".update-asset-sub-type").click(function() {
        $.ajax({
            type: "POST",
            url: appName + "/iadmin/manage-stakeholders/ajax-stakeholder-activity-edit",
            data: {stakeholder_activity_id: $(this).attr('id')},
            dataType: 'html',
