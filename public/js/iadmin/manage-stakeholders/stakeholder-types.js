$(function() {
    ...
    window.location.href = appName + '/iadmin/manage-stakeholders/stakeholder-types';
});

    
    $('#records').change(function() {
        var counter = $(this).val();
        document.location.href = appName + '/iadmin/manage-stakeholders/stakeholder-types/?counter=' + counter;
    });
    ...
    $("#add-stakeholder").validate({
        rules: {
            stakeholder_type: {
                required: true,
                remote: {
                    url: appName + "/iadmin/manage-stakeholders/check-stakeholder-type"
    ...
    $(".update-asset-sub-type").click(function() {
        $.ajax({
            type: "POST",
            url: appName + "/iadmin/manage-stakeholders/ajax-stakeholder-type-edit",
            data: {stakeholder_type_id: $(this).attr('id')},
            dataType: 'html',
