$(function() {
    $(function() {
        $("#manufacture_year_from").datepicker({
            dateFormat: 'dd/mm/yy',
            constrainInput: false,
            changeMonth: true,
            changeYear: true
        });
        $("#manufacture_year_to").datepicker({
            dateFormat: 'dd/mm/yy',
            constrainInput: false,
            changeMonth: true,
            changeYear: true
...
$(document).on("click", "a[id$='print_button']", function() {
    ...
    window.open(appName + '/cold-chain/print-transport?id=' + pk_id, '_blank', 'scrollbars=1,width=700,height=595');
});
