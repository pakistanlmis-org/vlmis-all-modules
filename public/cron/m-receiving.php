...
// Closing
     ...
     foreach ($dd['data'] as $key1 => $row1) {
            ...
            if (!empty($row0)) {
                ...
                $issuedqty = $row0['receivedqty'] == NULL ? 0 : $row0['receivedqty'];
            ...
            stock_master.to_warehouse_id = '$to_warehouse_id'"
                ...
                if (empty($res_select)) {
                    ...
                    VALUES ('$transactiondate', '$tr_number','$tr_counter','0','1','$from_warehouse_id','$to_warehouse_id','1','0','1',NOW(),'1',NOW())";
