 ...
 */
    function AddItemType() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error AddItemType");
 ...
 */
    function EditItemType() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error EditItemType");
 ...
 */
    function DeleteItemType() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error DeleteItemType");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
 ...
 */
    function GetItemTypeById() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetItemTypeById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
