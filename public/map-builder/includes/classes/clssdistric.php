...
class clsdistric {
    ...
    function Adddistric() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error Adddistric");
    ...
    function Editdistric() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error Editdistric");
    ...
    function Deletedistric() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error Deletedistric" . $this->m_dist_id);
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function GetAlldistric() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetAlldistric");
    ...
    function GetdistricById() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetdistricById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
