 ...
 */
    function Addlocations() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error Addlocations");
...
//query result
        $rsSql = mysqli_query($strSql) or die("Error Editlocations");
 ...
 */
    function DeleteLocation() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error Delete location");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
...
//query result
        $rsSql = mysqli_query($strSql) or die("Error GetAllLocations");
 ...
 */
    function GetLocationById() {
        ...
        $strSql = "SELECT
					...
					(CASE WHEN Province.LocType=2 THEN tbl_locations.ParentID else Province.ParentID  END) AS Province
				FROM
					tbl_locations
        ...
        //query result
       //echo $strSql;
        $rsSql = mysqli_query($strSql) or die("Error GetLocationById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
 ...
 */
    function get_location_name() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error get_location_name");
...
//query result
        $rsSql = mysqli_query($strSql) or die("Error GetLocationsByLevel");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
...
//query result
        $rsSql = mysqli_query($strSql) or die("Error GetAllProvinces");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
