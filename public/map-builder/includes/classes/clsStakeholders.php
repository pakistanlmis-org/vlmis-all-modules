...
class clsStakeholder {
    ...
    function AddStakeholder() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error AddStakeholder");

        $id = mysql_insert_id();
        if ($id > 0) {
            if ($this->m_MainStakeholder == 'NULL') {
                $strSql1 = "Update stakeholder SET MainStakeholder=" . $id . " where stkid=" . $id;
                $rsSql = mysqli_query($strSql1) or die($strSql1 . mysql_error());
            }
            return $id;
        } else {
            return 0;
    ...
    function EditStakeholder() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error EditStakeholder");
    ...
    function DeleteStakeholder() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error DeleteStakeholder");
        if (mysql_affected_rows()) { {
                return TRUE;
            }
        } else { {
    ...
    function DeleteComments(){
        ...
        $rsSql = mysqli_query($strSql) or die("Error DeleteComments");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function DeleteManufacturer() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error DeleteManufacturer");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function GetAllStakeholders() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetAllStakeholdersttttttttt");
    ...
    function GetStakeholdersLowersLevels() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error GetStakeholdersLowersLevels");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function GetAllLevels() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error GetAllLevels");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function GetAllStakeholdersOfficeTypes() {
        ...
        $strSql = "SELECT
					...
					Left Join tbl_dist_levels ON stakeholder.lvl = tbl_dist_levels.lvl_id
					ORDER BY stakeholder.stkid";
        $rsSql = mysqli_query($strSql) or die("Error GetAllStakeholdersOfficeTypes");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function GetAllStakeholdersAtParentlevel() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error GetAllStakeholdersAtlevel");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function GetAllStakeholderslddddd() {
        $strSql = "SELECT
					...
					FROM
										...
										Left Join tbl_dist_levels ON stakeholder.lvl = tbl_dist_levels.lvl_id
										where lvl_id !=3";
        $rsSql = mysqli_query($strSql) or die("Error GetAllStakeholderslvll");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function GetStakeholdersById() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error GetStakeholderById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
...
AND stakeholder_item.stk_id = " . $this->m_npkId;
        $rsSql = mysqli_query($strSql) or die("Error GetManufacturersById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function GetStakeholdersFamilyById() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error GetStakeholdersFamilyById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function GetStakeholdersFamilynatandpro() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error GetStakeholdersFamilynatandpro");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function GetRanks() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetRanks");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function get_stakeholder_name() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die($strSql . mysql_error());
    ...
    function GetMaxRank() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetMaxRank");
        if ($rsSql != FALSE && mysql_num_rows($rsSql) > 0) {
            $RowEditStk = mysql_fetch_object($rsSql);
    ...
    function GetMaxGroupID() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetMaxGroupID");
        if ($rsSql != FALSE && mysql_num_rows($rsSql) > 0) {
            $RowEditStk = mysql_fetch_object($rsSql);
    ...
    function GetAllManufacturersUpdate($item_pack_size_id) {
        ...
        $strSql = "SELECT
						...
						ORDER BY stakeholder.stkid";
        //query results
        $stSql = mysqli_query($strSql) or die("Error GetAllStakeholdersttttttttt");
    ...
    function GetAllManufacturers($item_pack_size_id) {
        ...
        $result_set = mysqli_query($strSql) or die("Error GetAllStakeholdersttttttttt");
    ...
    function GetAllMainStakeholders() {
        ...
        $strSql = mysqli_query($strSql) or die("Error GetAllMainStakeholders");
    ...
    function GetAllMainTransStakeholders() {
        ...
        $strSql = mysqli_query($strSql) or die("Error GetAllMainTransStakeholders");
