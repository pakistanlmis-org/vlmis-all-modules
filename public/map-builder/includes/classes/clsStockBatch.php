...
//query result
    ...
    public function FindItemQtyByBatchId($wh_id, $batch_id, $item_id) {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error: FindItemQtyByBatchId");
    ...
    function checkBatch() {
        ...
        //batch id
         $strSql = "SELECT
				...
				LIMIT 1";
//query result
        $result_obj = mysqli_query($strSql);
    ...
    function updateQty($id) {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error updateQty");
    ...
    function adjustQtyByWh($batch_id, $wh_id) {
        ...
        $rsSql = mysqli_query($strSql) or die("Error adjustQtyByWh" . $rsSql);
    ...
    function adjustQty($id, $qty) {
        ...
        $strSql .= " WHERE batch_id='" . $id . "'";
        $rsSql = mysqli_query($strSql) or die("Error adjustQty" . $rsSql);
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function updateName($id, $batch_no) {
        ...
        $strSql .= " WHERE batch_id='" . $id . "'";
        //query result
        $rsSql = mysqli_query($strSql) or die("Error updateName");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function changeStatus($batch_id, $status) {
        ...
        $rsSql = mysqli_query($strSql) or die("Error changeStatus");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function changeWh($batch_id) {
        ...
        $rsSql = mysqli_query($strSql) or die("Error changeWh");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function GetAllRunningBatches($item) {
      ...
      $strSql = "SELECT
					...
					GROUP BY
						stock_batch.batch_no";
//query result
        $rsSql = mysqli_query($strSql) or die("Error: GetAllRunningBatches");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function autoRunningLEFOBatch($product_id, $wh_id) {
        ...
        if ($expiry_date != false) {
            ...
            $rsSql = mysqli_query($strSql) or die("Error: autoStackedAllBatches");
            ...
            $strSql = "UPDATE stock_batch
					...
					LIMIT 1";
            $rsSql = mysqli_query($strSql) or die("Error: autoRunningLEFOBatch");
            if ($rsSql) {
                return TRUE;
            } else {
                return FALSE;
    ...
    function IsBatchExists($product_id, $wh_id) {
        ...
        $rsSql = mysqli_query($strSql) or die("Error: IsBatchExists");
    ...
    function GetBatchExpiry($id) {
        ...
        $rsSql = mysqli_query($strSql) or die("Error: GetBatchExpiry");
        if (mysql_num_rows($rsSql) > 0) {
            $row = mysql_fetch_object($rsSql);
            $data = array(
    ...
    function editBatchExpiry($id, $date) {
        ...
        $strSql .= " WHERE batch_id='" . $id . "'";
        $rsSql = mysqli_query($strSql) or die("Error editBatchExpiry");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
