...
class clsIwh_user {
    ...
    function Addwh_user() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error Addwh_user");
...
//query result
        $rsSql = mysqli_query($strSql) or die("Error wh_user");
        if (mysql_affected_rows()) {
            return $rsSql;
        } else {
            return FALSE;
...
//query result
        $rsSql = mysqli_query($strSql) or die("Error Deletewh_user");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function Deletewh_userbyuserid() {
        ...
        //query result
        //echo $strSql;exit;
        $rsSql = mysqli_query($strSql) or die("Error Deletewh_userbyuserid");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function GetAllwh_user() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetAllwh_user");
...
//query result
        $rsSql = mysqli_query($strSql) or die("Error Getwh_userByIdhhhhhhh");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function GetwhuserByIdc() {
        ...
        $strSql = "SELECT
					...
					ORDER BY
						...
						A.wh_name ASC";
        //query result
        $rsSql = mysqli_query($strSql) or die("Error Getwh_userById");
        //fetch results
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
    ...
    function GetProvinceIdByIdc() {
        ...
        //gets
        //province id
        if ($this->m_npkId == "8904") {
            $province_id = array("prov_id" => 2);
            return $province_id;
        }
        $strSql = "SELECT
