...
//query result
            $rsSql = mysqli_query($strSql) or die("Error Add Content1");
    ...
    function Editlogocontent() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error Edit Content");
    ...
    function Deletelogocontent() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error Delete Content");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
