...
class clsLevels {
    ...
    function AddLevels() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error AddLevels");
    ...
    function EditLevels() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error EditLevels");
    ...
    function DeleteLevels() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error DeleteLevels");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function GetAllLevelss() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error GetAllLevelss");
