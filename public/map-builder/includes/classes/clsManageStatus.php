 ...
 */
    function AddItemStatus() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error AddItemStatus");
 ...
 */
    function EditItemStatus() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error EditItemStatus");
 ...
 */
    function DeleteItemStatus() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error DeleteItemStatus");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
 ...
 */
    function GetItemStatusById() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetItemStatusById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
