...
class clsItemGroup {
    ...
    function AddItemGroup() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error AddItemGroup");
    ...
    function EditItemGroup() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error EditItemGroup");
    ...
    function DeleteItemGroup() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error DeleteItemGroup");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function GetItemGroupById() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetItemGroupById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
