...
class clsStk_Type {
    ...
    function AddStk_type() {
        ...
        //result
        $rsSql = mysqli_query($strSql) or die("Error Addstk_type");
    ...
    function EditStk_type() {
        ...
        //result
        $rsSql = mysqli_query($strSql) or die("Error Editstk_type");
    ...
    function DeleteStk_type() {
        ...
        //result
        $rsSql = mysqli_query($strSql) or die("Error Deletestk_type");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function GetAllstk_types() {
        ...
        //result
        $rsSql = mysqli_query($strSql) or die("Error GetAllstk_types");
    ...
    function GetStk_type_descrById() {
        ...
        //result
        $rsSql = mysqli_query($strSql) or die("Error Getstk_typeById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
