...
class ClsReports
{
    ...
    function editableMonths()
	{
		...
		$qry = "SELECT
                ...
                //query result
		$qryRes = mysql_fetch_array(mysqli_query($qry));
    ...
    function getReportingStartMonth()
	{
		...
		$qry = "SELECT
				...
				WHERE
					tbl_warehouse.wh_id = " . $this->wh_id;
                //query result
		$firstMonth = mysql_fetch_array(mysqli_query($qry));
    ...
    function GetLastReportDate()
	{
		...
		//query result
        $rs = mysql_fetch_object(mysqli_query($query));
		if(!empty($rs->MaxDate)) {
			$d = $rs->MaxDate;
        ...
        function GetLastReportDateHFType()
	{
		...
		//query result
                $rs = mysqli_query($query) or die(print mysql_error());
