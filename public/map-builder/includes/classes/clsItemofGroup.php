...
class clsItemOfGroup {
    ...
    function AddItemOfGroup() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error AddItemOfGroup1");
        $n_group--;
    ...
    function EditItemOfGroup() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error DeleteItemOfGroup");
        $rsSql = mysqli_query($strSql) or die("Error EditItemOfGroup");
        if (mysql_affected_rows()) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function DeleteGroup() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error DeleteItemOfGroup1");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function GetAllItemOfGroup() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetAllItemOfGroup");
    ...
    function GetItemOfGroupById() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetItemOfGroupById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
    ...
    function GetItemsOfGroupById() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetItemsOfGroupById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
