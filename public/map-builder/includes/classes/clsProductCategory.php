...
class clsItemCategory {
    ...
    function AddItemCategory() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error AddItemCategory");
    ...
    function EditItemCategory() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error EditItemCategory");
    ...
    function DeleteItemCategory() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error DeleteItemCategory");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
    ...
    function GetItemCategoryById() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetItemCategoryById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
