...
//npkId
    ...
    function AddHealthFacilityType() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error AddHealthFacilityType");
 ...
 */
    function EditHealthFacilityType() {
        ...
        $rsSql = mysqli_query($strSql) or die("Error EditHealthFacilityType");
...
//query result
        $rsSql = mysqli_query($strSql) or die("Error DeleteHealthFacilityType");
        if (mysql_affected_rows()) {
            return TRUE;
        } else {
            return FALSE;
 ...
 */
    function GetAllHealthFacilityType() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetAllHealthFacilityType");
 ...
 */
    function GetHealthFacilityById() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetHealthFacilityById");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
 ...
 */
    function GetNewRank() {
        ...
        //query result
        $rsSql = mysqli_query($strSql) or die("Error GetNewRank");
        if (mysql_num_rows($rsSql) > 0) {
            return $rsSql;
        } else {
            return FALSE;
