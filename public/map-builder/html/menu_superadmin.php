...
<div class="page-sidebar-wrapper"> 
    ...
    <div class="page-sidebar navbar-collapse collapse"> 
        ...
        <ul class="page-sidebar-menu accordion" id="accordion">
			...
			<li> <a href="<?php echo APP_URL;?>admin/Manage_list_master.php"> <i class="fa fa-map-marker"></i> <span class="title">List Master/Detail</span> </a> </li>
            <li> <a href="<?php echo APP_URL;?>admin/ManageDashboardComments.php"> <i class="fa fa-map-marker"></i> <span class="title">Dashboard Comments</span> </a> </li>
            <li> <a href="<?php echo APP_URL;?>admin/manage_requisition_flow.php"> <i class="fa fa-map-marker"></i> <span class="title">Requisitions Flow</span> </a> </li>
